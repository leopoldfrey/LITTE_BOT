...
echo "Starting Led"
$job2 = Start-Job -Name LitteBotLed -ScriptBlock {
  cd D:\PLASTICSCM_LITTLEBOT\LITTE_BOT\LitteBotLed;
   node ./ledCtrl.js
}

$host.UI.RawUI.ForegroundColor = "Magenta"
echo "Starting Sound"
$job3 = Start-Job -Name LitteBotSound -ScriptBlock {
...
echo "Starting Brain"
$job4 = Start-Job -Name LitteBotBrain -ScriptBlock {
  cd D:\PLASTICSCM_LITTLEBOT\LITTE_BOT\LitteBotServer;
...
$job5 = Start-Job -Name LitteBotServer -ScriptBlock {
  cd D:\PLASTICSCM_LITTLEBOT\LITTE_BOT\LitteBotServer
